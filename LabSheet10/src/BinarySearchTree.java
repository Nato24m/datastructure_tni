...
///////////////////////////////////////////////////////////////////////////
	...
	public void delete(int target) {
		...
		if(isEmpty()) {
			...
			//Case 3 : delete node with 1 children
			else {
	...
	public void deleteByLeftSubTree() {
		 ...
		 int maxValue = findMaximum(deleteNode.left);//SET maxValue WITH THE MAXIMUM NODE IN LEFT SUBTREE
	...
	public void deleteByRightSubTree() {
		 ...
		 int maxValue = findMaximum(deleteNode.right);
		 delete(maxValue); 
